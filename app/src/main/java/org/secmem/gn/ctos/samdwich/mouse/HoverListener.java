...
public class HoverListener implements View.OnTouchListener {
    ...
    private HoverGestureListener mGestureListener;
    public HoverListener(PointingStickController mPointingStickController)
    {
        mGestureListener=new HoverGestureListener(mPointingStickController);

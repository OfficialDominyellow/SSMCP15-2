...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    private void onBufferDraw() {
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            //keyBackground.setBounds(0, 0, 0, 0);
            canvas.translate(key.x + kbdPaddingLeft, key.y + kbdPaddingTop);
            // Rotate the canvas
            canvas.save();
            canvas.rotate((float)Math.toDegrees(key.rotate)-90,key.width/2,key.height/2);
            ...
            if (label != null) {
                ...
                // Rotate the canvas
                canvas.save();
                canvas.rotate((float)Math.toDegrees(key.rotate)-90,key.icon.getIntrinsicWidth()/2,key.icon.getIntrinsicWidth()/2);
